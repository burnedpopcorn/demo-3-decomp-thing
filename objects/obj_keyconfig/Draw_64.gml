...
{
    draw_text_colour(832, 25, "PLAYER 1", c_white, c_white, c_white, c_white, 1)
    if (key_select == -1)
...
if (player == obj_randomenemyspawner)
{
    draw_text_colour(832, 25, "PLAYER 2", c_white, c_white, c_white, c_white, 1)
    if (key_select == -1)
        draw_text_colour(64, 25, "BACK", c_white, c_white, c_white, c_white, 1)
    else
        draw_text_colour(64, 25, "BACK", c_white, c_white, c_white, c_white, 0.5)
