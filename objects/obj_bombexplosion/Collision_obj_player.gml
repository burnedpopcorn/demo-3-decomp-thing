with (other.id)
{
    if ((instance_exists(obj_water) && other.y >= obj_water.bbox_top) || room == factory_5)
    {
        ...
        else if (state != 114 && state != (126 << 0) && state != 113 && character == "V")
        {
            vsp = -2
            scr_hurtplayer(object_index)
        }
        else if (hurted == 0 && cutscene == 0 && state != (126 << 0) && state != 114 && state != 113 && state != 27 && sprite_index != spr_bombpep_end && state != 63 && state != 65)
        {
            image_index = 0
            hurted = 1
            vsp = -4
    ...
    {
        if (hurted == 0 && cutscene == 0 && state != (126 << 0) && state != 114 && state != 113 && state != 27 && sprite_index != spr_bombpep_end && state != 63 && state != 65)
        {
    ...
    else if (state != 114 && state != (126 << 0) && state != 113)
    {
        vsp = -2
        scr_hurtplayer(object_index)
    }
