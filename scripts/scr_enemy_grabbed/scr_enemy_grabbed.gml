function scr_enemy_grabbed() //gml_Script_scr_enemy_grabbed
{
    if (grabbedby == 1)
    {
        ...
        if (obj_player1.state == 28 || obj_player1.state == (122 << 0) || obj_player1.state == 46 || obj_player1.state == 41 || obj_player1.state == 42 || obj_player1.state == 10 || obj_player1.state == (129 << 0))
        {
            x = obj_player1.x
        ...
        with (obj_player1)
        {
            ...
            if (!((state == 46 || state == (122 << 0) || state == 3 || state == 28 || state == 41 || state == 42 || state == 10 || state == 47 || state == 43 || state == 48 || state == 49 || state == 50 || state == (129 << 0))))
            {
                other.x = x
                other.y = y
                other.state = 106
        ...
        if place_meeting(x, y, obj_swordhitbox)
        {
            ...
            with (obj_player1)
            {
                ...
                {
                    other.blowdirection = 3
                    other.playerxscale = xscale
                }
                else
                {
                    other.blowdirection = 1
                    other.playerxscale = xscale
                }
            }
        }
    ...
    if (grabbedby == 2)
    {
        ...
        if (obj_player2.state == 28 || obj_player2.state == (122 << 0) || obj_player2.state == 46 || obj_player2.state == 41 || obj_player2.state == 42 || obj_player2.state == 10)
        {
            x = obj_player2.x
        ...
        with (obj_player2)
        {
            ...
            if (!((state == 46 || state == (122 << 0) || state == 3 || state == 28 || state == 41 || state == 42 || state == 10 || state == 47 || state == 43 || state == 48 || state == 49 || state == 50)))
            {
                other.x = x
                other.y = y
                other.state = 106
